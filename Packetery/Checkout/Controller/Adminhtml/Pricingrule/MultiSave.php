...
class MultiSave extends Action implements HttpPostActionInterface
{
    ...
    public function execute(): Redirect
    {
        ...
        foreach ($postData as &$carrierPriceRule) {
            ...
            $pricingRule['carrier_name'] = ($carrierName !== null && $carrierName !== '' ? $carrierName : null);
            ...
            if (!isset($pricingRule['max_cod']) || $pricingRule['max_cod'] === '' || !is_numeric($pricingRule['max_cod'])) {
            ...
            if ($hybridCarrier->hasVendorGroupsOptions() && (empty($pricingRule['vendor_groups']) || count($pricingRule['vendor_groups']) < 2)) {
